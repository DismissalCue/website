...
`dismissalcue-story.mp4` is a separate 91.50-second, 1280×720, 30fps H.264/AAC
...
The revised film uses Chris, a conversational American voice, at normal1.0 speed with
stability0.45, similarity0.75 and style0.05. Natural sentences and short breathing pauses balance the earlier brisk delivery
and the slower first revision. The script includes exhaust from idling cars
